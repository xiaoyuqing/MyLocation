...
//  MyLocation
//
//  Created by Zhouxm on 2018/2/11.
...
- (void)viewDidLoad {
    [super viewDidLoad];
    // 如果要想知道任意位置的坐标
    //1. 去高德地图 http://lbs.amap.com/console/show/picker，选中自己坐标
    // 阿里  113.942191  22.509939
    //2. 在进行坐标转换
    CLLocationCoordinate2D location2D = CLLocationCoordinate2DMake(22.509939, 113.942191);
    ...
    // 纬度：22.512958, 经度：113.937318
    //3. 去 Location1.gpx 修改经纬度
}
